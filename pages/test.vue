...
export default {
    ...
    head: {
        ...
        script: [
            ...
            // { src: "https://d1ktbyo67sh8fw.cloudfront.net/js/theta.umd.min.js", defer: true},
            // // an HLS.js plugin made with the theta code (that is also used within the videojs plugin?)
            // { src: "https://d1ktbyo67sh8fw.cloudfront.net/js/theta-hls-plugin.umd.min.js", defer: true},
